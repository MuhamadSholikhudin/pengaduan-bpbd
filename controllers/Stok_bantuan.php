<?php 
    ...
    class Stok_bantuan {
        ...
        public function Update($request){
            ...
            $selisih_stok = $stok_masuk_lama['stok_masuk'] - $request['stok_masuk'];

            $stok_tersedia_baru =  $stok_tersedia_lama['stok_tersedia'] + $selisih_stok;
            ...
            Redirect("http://localhost/pengaduan-bpbd/?stok_bantuan=stok_bantuan_keluar", "Data Berhasil Di Ubah");
        }
    }