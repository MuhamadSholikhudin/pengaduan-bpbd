          ...
          <div class="row">
            ...
            <div class="col-lg-6 grid-margin stretch-card">
              <div class="card">
                ...
                <div class="card-body">
                  <div class="row">
                    <form class="forms-sample" action="<?= $url ?>/?stok_bantuan=stok_bantuan_update" method="POST" enctype="multipart/form-data">
                    <input type="hidden" name="id_stok_bantuan" value="">  
