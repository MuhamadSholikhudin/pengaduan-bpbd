...
<div class="main-panel">
    <div class="content-wrapper">
        ...
        <h1 class="welcome-text text-center mb-3">Laporan posko </h1>
        ...
        <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="http://localhost/pengaduan-bpbd/?laporan=posko" method="POST">
                                <table class="table">
                                    <tr>
                                        <td>
                                            Dari
            ...
            <?php 
                if (  isset($_GET['tanggal_awal']) && isset($_GET['tanggal_akhir'])  ) {
                    $sql_posko = "SELECT * FROM posko WHERE tanggal_posko BETWEEN '" . $_GET['tanggal_awal'] . "' AND '" . $_GET['tanggal_akhir'] . "' ";
                    $link = "&tanggal_awal=".$_GET['tanggal_awal']."&tanggal_akhir=".$_GET['tanggal_akhir']."";
                } elseif (isset($_GET['bulan']) && isset($_GET['tahun'])) {
                    $sql_posko = "SELECT * FROM posko WHERE MONTH(tanggal_posko) = " . $_GET['bulan'] . " AND YEAR(tanggal_posko) = '" . $_GET['tahun'] . "' ";
                    $link = "&bulan=".$_GET['bulan']."&tahun=".$_GET['tahun']."";
                } elseif (isset($_GET['tahun'])) {
                    $sql_posko = "SELECT * FROM posko WHERE  YEAR(tanggal_posko) = '" . $_GET['tahun'] . "' ";
                    $link = "&tahun=".$_GET['tahun']."";
                } else {
                    $sql_posko = "SELECT * FROM posko";
                    $link = "";
                }
            ?>
            ...
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-12">
                                <h4 class="card-title text-center">Data posko</h4>
                            </div>
                            <div class="col-lg-12">
                                <a target="_blank" href="http://localhost/pengaduan-bpbd/?laporan=posko_cetak<?= $link ?>" class="btn btn-warning btn-sm">
                                    <i class="ti-printer"></i>
                                    &nbsp; 
                                    Cetak
                                </a>
                                &nbsp; 
                                <!-- <a href="http://localhost/pengaduan-bpbd/?laporan=posko_pdf" class="btn btn-danger btn-sm">
                                    <i class="fa fa-file"></i>
                                    &nbsp; 
                                    PDF
                                </a> -->
                                &nbsp; 
                                <!-- <a href="http://localhost/pengaduan-bpbd/?laporan=posko_excel<?= $link ?>" class="btn btn-success btn-sm">
                                    <i class="ti-file"></i>
                                    &nbsp; 
                                    EXCEL
                                </a>                                 -->
