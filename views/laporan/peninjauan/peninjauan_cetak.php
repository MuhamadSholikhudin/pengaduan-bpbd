<?php 
    if (isset($_GET['tanggal_awal']) && isset($_GET['tanggal_akhir'])) {
        $sql_peninjauan = "SELECT * FROM peninjauan WHERE tanggal_peninjauan BETWEEN '" . $_GET['tanggal_awal'] . "' AND '" . $_GET['tanggal_akhir'] . "' AND status_peninjauan != 'belum dikirim' ";
        ...
        $sql_peninjauan = "SELECT * FROM peninjauan WHERE MONTH(tanggal_peninjauan) = " . $_GET['bulan'] . " AND YEAR(tanggal_peninjauan) = '" . $_GET['tahun'] . "' AND  status_peninjauan != 'belum dikirim' ";
        $hal = " bulan ". BulanIndonesia($_GET['bulan'])." Tahun ". $_GET['tahun'];
    } elseif (isset($_GET['tahun'])) {
        $sql_peninjauan = "SELECT * FROM peninjauan WHERE  YEAR(tanggal_peninjauan) = '" . $_GET['tahun'] . "' AND  status_peninjauan != 'belum dikirim' ";
        $hal = " Tahun ". $_GET['tahun'];
    } else {
        $sql_peninjauan = "SELECT * FROM peninjauan WHERE status_peninjauan != 'belum dikirim' ";
        $hal = "";
    }
    ...
    <span class="text-center" style="font-size: 16xpx; font-weight:700;">NOTA DINAS</span>
        <table style="text-align: left;">
            ...
            <tr>
                ...
                <td valign="top"> : </td>
                <td valign="top">Laporan Peninjauan Data Bencana Kab. Kudus <?= $hal ?></td>
            </tr>
        </table>
        <br>
