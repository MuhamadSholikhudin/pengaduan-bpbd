                  ...
                  <div class="row">
                    <form class="forms-sample" action="<?= $url ?>/?pelaporan=update" method="POST" enctype="multipart/form-data">
                      <div class="form-group">
                        ...
                        <input type="hidden" class="form-control p-input" id="id_pelaporan" name="id_pelaporan" value="<?= $satu_pelaporan[
                            'id_pelaporan'
                        ] ?>">
                        <input type="hidden" class="form-control p-input" id="id_user" name="id_user" value="<?= $_SESSION[
                            'id_user'
                        ] ?>">
                        <input type="hidden" class="form-control p-input" name="status_pelaporan" value="<?= $satu_pelaporan[
                            'status_pelaporan'
                        ] ?>">
                        <input type="text" class="form-control p-input" value="<?= $_SESSION[
                            'nama_user'
                        ] ?>" disabled>
                      </div>
                      <div class="form-group">
                        <label for="tanggal_pelaporan">* Tanggal pelaporan</label>
                        <input type="date" class="form-control p-input" id="tanggal_pelaporan" name="tanggal_pelaporan" value="<?= $satu_pelaporan[
                            'tanggal_pelaporan'
                        ] ?>" <?php echo $_GET['pelaporan'] == 'edit' ? '': 'disabled'; ?>>
                      </div>
                      <div class="form-group">
                        <label for="pelaporan">* Wilayah</label>
                        <select class="js-example-basic-single form-control" name="id_wilayah" <?php echo $_GET[
                            'pelaporan'
                        ] == 'edit'
                            ? ''
                            : 'disabled'; ?>  >
    ...
    'nama_bencana'
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="form-control" id="pelaporan" name="pelaporan" style="height: 300px;" <?php echo $_GET[
                            'pelaporan'
                        ] == 'edit'
                            ? ''
                            : 'disabled'; ?>><?= $satu_pelaporan[
    'pelaporan'
] ?></textarea>
                      </div>
                      <div class="form-group">
    ...
    'gambar_lokasi_bencana'
                ...
                <div class="form-group">
                  ...
                  <input type="url" class="form-control p-input" id="link_maps" name="link_maps" value="<?= $satu_pelaporan[
                      'link_maps'
                  ] ?>">
                </div>
                <div class="form-group">
