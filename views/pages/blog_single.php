   <?php 
    //menampilkan datu data publikasi berdasarkan id_publikasi
    $publikasi = Querysatudata("SELECT * FROM publikasi WHERE id_publikasi = ".$_GET["id"]."");
   ?>
...
<div class="entry-img">
  <img src="gambar/publikasi/<?= $publikasi["gambar"] ?>" style="width: 100%;" alt="" class="img-fluid">
</div>
