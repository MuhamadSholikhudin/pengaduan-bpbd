                      ...
                      <form class="forms-sample" action="<?= $url ?>/?publikasi=update" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-12">
                          ...
                          if($_SESSION['level'] == "petugas_logistik"){
                            ?>
                              <a href="<?= $url ?>?distribusi=distribusi" class="badge badge-success"> <i class="ti-arrow"></i> Kembali</a>
                              <?php
                          }elseif($_SESSION['level'] == "petugas_bpbd"){
                            ?>
                            <a href="<?= $url ?>?publikasi=publikasi" class="badge badge-success"> <i class="ti-arrow"></i> Kembali</a>
