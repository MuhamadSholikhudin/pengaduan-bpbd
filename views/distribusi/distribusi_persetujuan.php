            ...
            <div class="col-lg-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-header">
                  <h2><?= strtoupper('Edit data Persetujauan ' . array_keys($_GET)[0]) ?></h2>
                </div>
                <div class="card-body">
                  <div class="row">
                    ...
                    ?>
                      ...
                      <label for="status_distribusi">Status distribusi</label>
                        <?php 
                            $setujuis = ["Setujui", "Tidak setujui"];
                        ?>
                        <select class=" form-control" id="status_distribusi" name="status_distribusi" required>
                            <?php
                            //Menampilkan data looping array
                            foreach ($setujuis as $setujui) {
                              if($setujui == $satu_distribusi['status_distribusi']){
                                ?>
                                <option value="<?= $setujui ?>" selected data-id="<?= $setujui ?>"><?= $setujui ?></option>
                              <?php
                              }else{
                                ?>
                                <option value="<?= $setujui ?>" data-id="<?= $setujui ?>"><?= $setujui ?></option>
                              <?php
                              }                            
                              }
                            ?>
                ...
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="col-12 mt-3 text-center">
                      ...
                      <?php
                      }elseif($_SESSION["level"] == "kepala_bpbd") {
                        ?>
                        <button type="submit" class="btn btn-success" onclick="ProcessPersetujuan();">
                          <i class="ti-cyrcle"></i>
                          Process
                        </button>
                      <?php
