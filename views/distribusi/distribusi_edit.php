                ...
                <div class="card-body">
                  <div class="row">
                    <!-- <form class="forms-sample" action="<?= $url ?>/?stok_bantuan=stok_bantuan_post" method="POST" enctype="multipart/form-data"> -->
                      <input type="hidden" class="form-control p-input" id="id_distribusi" aria-describedby="id_distribusi" name="id_distribusi" placeholder="<?= $_GET['id'] ?>">
                  ...
                  <div class="table-responsive">
                    ...
                    <?php 
                      ...
                      foreach($bantuan_distribusis as $bantuan_distribusi){
                        $bantuan = Querysatudata("SELECT * FROM bantuan WHERE id_bantuan = ".$bantuan_distribusi['id_bantuan_distribusi']."")
                    ?>
                      <tr>
                        <td><?= $no++; ?></td>
                        <td><?= $bantuan['nama_bantuan']; ?></td>
                        <td>
                          <input class="form-control" type="hidden" name="bantuan_id[]" min="0" value="<?= $bantuan_distribusi['id_bantuan_distribusi']; ?>">                         
