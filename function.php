...
function TanggalIndonesia($tanggal = string){
    ...
    $day_hire = gmdate("l", mktime(0,0,0,  $date_month_hire, $date_day_hire, $date_year_hire));
    ...
    return $day_indo_hire.", ". $date_day_hire. " ". $month_indo_hire . " ". $date_year_hire;
}


function TanggalIndonesiaTime($tanggal = string){
    $date_hire = new \DateTime($tanggal);
    $date_year_hire = date_format($date_hire, "Y"); //for Display Year
    $date_month_hire =  date_format($date_hire, "m"); //for Display Month
    $date_day_hire = date_format($date_hire, "d"); //for Display Date
    ...
    return $day_indo_hire.", ". $date_day_hire. " ". $month_indo_hire . " ". $date_year_hire. " ".$time;
}
